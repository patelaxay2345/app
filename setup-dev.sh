...
log_info "Next Steps:"
echo ""
echo "  1. ${YELLOW}Update MongoDB connection string${NC}"
echo "     Edit: ${BLUE}backend/.env${NC}"
echo "     Set MONGO_URL to your MongoDB connection string"
echo ""
echo "  2. ${YELLOW}Start the application${NC}"
echo "     ${GREEN}Option A - Separate terminals:${NC}"
echo "       Terminal 1: ${BLUE}./start-backend.sh${NC}"
echo "       Terminal 2: ${BLUE}./start-frontend.sh${NC}"
echo ""
echo "     ${GREEN}Option B - Single command (background):${NC}"
echo "       ${BLUE}./start-all.sh${NC}"
echo ""
echo "  3. ${YELLOW}Access the application${NC}"
echo "     Frontend: ${BLUE}http://localhost:3000${NC}"
echo "     Backend API: ${BLUE}http://localhost:8001${NC}"
echo "     API Docs: ${BLUE}http://localhost:8001/docs${NC}"
echo ""
echo "  4. ${YELLOW}Login with default credentials${NC}"
echo "     Username: ${BLUE}admin${NC}"
echo "     Password: ${BLUE}Admin@2024${NC}"
echo ""
